...
//    new_msg.mtype = 1;
//
//    char *mes = malloc(sizeof(char) * MAX_LOG_MES_SIZE);
...
//        strcat(buf, message);
//        strcat(buf, "\n");
//        snprintf(mes, MAX_LOG_MES_SIZE, buf, ap);
//    }
...
//    }
//    else{
//        snprintf(mes, MAX_LOG_MES_SIZE, "ERROR IN LOGGING\n");
//
//    }
//    strcpy(new_msg.mtext, mes);
